(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'K0t3zUIcbQBPxxzMmqNZbX0tJE3y8uMjkwHvziLtnsCBSBEt', // Unique master Xively API key to be used as a default
		defaultFeeds	= [41913791], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Temperatures Montgeron', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
